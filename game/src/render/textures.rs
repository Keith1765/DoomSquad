...
impl Texture {
    ...
    pub fn get_texture_column(
        ...
        let inworld_onscreen_ratio =  inworld_height / onscreen_height as f64;
            ...
            ..onscreen_top.clamp(0, renderer_data.screen_height_as_isize)
        {
            ...
            let inworld_y_on_tex = (onscreen_y_on_tex as f64 * inworld_onscreen_ratio) as usize; // TODO very slow: improve somehow?
