...
-   Slot Machine: randomly either restores some health, or spawns a melee enemy; Easteregg: small chance (10%) of swapping map to old test map that was used during developmen
